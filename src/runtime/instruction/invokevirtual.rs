...
pub fn invoke_virtual(vm: &Vm, ctx: &mut CallSite, bytes: &mut Bytes) -> Result<()> {
    ...
    // peek the value since its passed as the first arg to the function, to represent "this"
